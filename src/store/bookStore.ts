...
export const initialBooks: Book[] = [
  {
    ...
    markdownPath: '/books/book1_suzhizhe/content.md',
    tags: ['文学小说', '社会隐喻', '女性文学'],
  ...
  },
  {
    ...
    markdownPath: '/books/book2_xidaduo/content.md',
    tags: ['哲学', '成长', '自我探索'],
  ...
  },
  {
    ...
    markdownPath: '/books/book3_qietingfengyin/content.md',
    tags: ['村上春树', '青春', '文学'],
  ...
  },
  {
    ...
    markdownPath: '/books/book4_nuoweidesenlin/content.md',
    tags: ['村上春树', '爱情', '青春'],
  ...
  },
  {
    ...
    markdownPath: '/books/book5_dangwotanpaobushiwotanxieshenme/content.md',
    tags: ['跑步', '人生感悟', '村上春树'],
  ...
  },
  {
    ...
    markdownPath: '/books/book6_SQLbizhibihui/content.md',
    tags: ['SQL', '数据库', '技术'],
  ...
  },
  {
    ...
    markdownPath: '/books/book7_hamaxainsheng/content.md',
    tags: ['心理学', '成长', '自我认知'],
