...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {/* 社交链接 - 右侧中间位置 */}
      <aside className="fixed right-6 top-1/2 -translate-y-1/2 z-40 flex flex-col space-y-4">
        {/* 社交链接标题 */}
        ...
        {/* GitHub链接 */}
        <a
          href="https://github.com/shallow157"
          target="_blank"
          ...
          aria-label="GitHub"
        >
          <svg className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          aria-label="Email"
        >
          <svg className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
        </a>

        {/* 装饰线条 */}
        <div className="w-px h-8 bg-gradient-to-b from-transparent via-gray-300 dark:via-gray-600 to-transparent mt-3"></div>
      </aside>
